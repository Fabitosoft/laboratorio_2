...
import CreateForm from './forms/ordenes_form';
import Tabla from './ordenes_tabla';
...
class List extends Component {
    constructor(props) {
        ...
        this.plural_name = 'Ordenes';
        this.singular_name = 'Orden';
    }
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        cargando();
        this.props.fetchOrden(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.createOrden(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.updateOrden(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.deleteOrden(item.id, success_method, notificarErrorAjaxAction);
    }
