...
class List extends Component {
    constructor(props) {
        ...
        this.plural_name = 'Especialidades';
        this.singular_name = 'Especialidad';
    }
    ...
    fetchObjectMethod(item_id, successCallback) {
        ...
        cargando();
        this.props.fetchEspecialidad(item_id, success_method, notificarErrorAjaxAction);
    }
    ...
    createObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.createEspecialidad(item, success_method, notificarErrorAjaxAction);
    }
    ...
    updateObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.updateEspecialidad(item.id, item, success_method, notificarErrorAjaxAction);
    }
    ...
    deleteObjectMethod(item, successCallback) {
        ...
        cargando();
        this.props.deleteEspecialidad(item.id, success_method, notificarErrorAjaxAction);
    }
